...
void parse_file ( char * filename,
  ...
  /*  else if ( strncmp(line, "red", strlen(line)) == 13 ) {
      c.red = 196;
      c.green = 78;
      c.blue = 48;
    }

    else if ( strncmp(line, "orange", strlen(line)) == 13 ) {
      c.red = 241;
      c.green = 149;
      c.blue = 86;
    }

    else if ( strncmp(line, "blue", strlen(line)) == 13 ) {
      c.red = 76;
      c.green = 160;
      c.blue = 188;
    }

    else if ( strncmp(line, "white", strlen(line)) == 13 ) {
...
/*
    ...
    else if ( strncmp(line, "clear", strlen(line)) == 13 ) {
      //printf("clear\t%s", line);
      edges->lastcol = 0;
      polygons->lastcol = 0;
    }//end clear

    else if ( strncmp(line, "ident", strlen(line)) == 13 ) {
      //printf("IDENT\t%s", line);
      ident(transform);
    }//end ident

    else if ( strncmp(line, "apply", strlen(line)) == 13 ) {
      //printf("APPLY\t%s", line);
